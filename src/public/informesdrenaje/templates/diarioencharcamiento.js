        ...
        <tbody>
            <tr>
                <td>
                    <table>
                    <tr>
                        <td colspan="6" style="font-size: 12pt; background-color: #ffffff; text-align:center; font-weight: bold;">INFORME DIARIO DE ENCHARCAMIENTOS  <br> <span style="font-size: 10pt;">VIALIDAD PRIMARIA Y SECUNDARIA</p> </td>
                    </tr>
                    <tr>
                        <td colspan="6" style="font-size: 10pt; background-color: #ffffff; text-align:center; font-weight: bold; color:rgba(255, 0, 0, 0);">Espacio</td>
                    </tr>
                    <tr>
    ...
    <table align="center" style="width: 70%;">
        <thead>
            ...
            <tr>
                ...
                <th
                    style="background-color: #E5E8EA; font-size: 7pt; text-align:center; font-weight: bold; line-height: 1.2; border: 1px solid rgb(0, 0, 0);">
                    Tiempo Solución Promedio (minutos)</th>
            </tr>
            <thead>
