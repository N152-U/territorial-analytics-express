module.exports = {
    reportesdrenajefuncion: (startDate, finalDate, today, reportesdrenaje, tmpl,logoCDMXB64, logoCiudadInnovadoraB64) => {
      let html = '', repairsDrainage = '';
    ...
    reportesdrenaje.forEach(element => {
    ...
    repairsDrainage = `${repairsDrainage}
...
<tbody>`
    ...
    html = tmpl
      ...
      .replace("{{today}}", today)
      .replace("{{repairsDrainage}}", repairsDrainage);
