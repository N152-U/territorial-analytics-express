module.exports = {
    relacionpendientes: (startDate, finalDate, today, relacionpendientes, tmpl, logoCDMXB64, logoCiudadInnovadoraB64) => {
        let html, incidents = '', index = 0, register = 0, grand_total = 0, headMunicipality = '', headColumns = '';

        if (relacionpendientes != '') {

            relacionpendientes.forEach(value => {

                grand_total += Number(value.subtotal_incidents);

                headMunicipality = `<table  class="table table-bordered" style="padding:0px!important;">
