...
<head>
    ...
    <title>reportespendientesperiodosistemas</title>
            ...
            <tr>
                <td>
                    ...
                    <table class="table table-bordered">
                        <tr>
                            <th colspan="3"
                                style=" font-size: 8pt;  background-color: #D9D9D9!important; text-align:center; font-weight: bold; ">
                                TOTAL</th>
                            <th
                                style=" font-size: 8pt;  text-align:center; background-color: #D9D9D9!important ; font-weight: bold;">
                                {{grand_total}}</th>
                        </tr>
                    </table>
                </td>
