            ...
            <tr>
                <td>
                    <table style="padding: 0px 0px 0px 20px;  margin-top: -5px">
                        <tr>
                            <td colspan="6"
                                ...
                                RELACIÓN DE FALTAS DE AGUA PENDIENTES
                            </td>
                        </tr>
                        <tr>
                        <td colspan="4"
                    ...
                    <table class="table table-bordered">
                        <tr>
                            <th colspan="3"
                                style=" font-size: 9pt;  background-color: #D9D9D9 !important; text-align:center; font-weight: bold; ">
                                TOTAL</th>
                            <th
                                style=" font-size: 9pt;  text-align:center; background-color: #D9D9D9 !important; font-weight: bold;">
                                {{grand_total}}</th>
                        </tr>
                    </table>
                </td>
